...
# New HF CLI + optional accelerate transfer
...
download() {
  # Uses new CLI; resumes and verifies hashes automatically
...
# Restart ComfyUI if the service exists; else start a background instance
